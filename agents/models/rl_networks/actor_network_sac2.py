...
class ActorNetwork(nn.Module):
    def __init__(self, num_inputs, image_latent_size, state_size, fc1_dims, fc2_dims, lr, device, checkpoint_dir, log_sig_min=-20, log_sig_max=2, epsilon=1e-6):
...
#     actor = ActorNetwork(num_inputs=30000, latent_size=256, fc1_dims=50,fc2_dims=25, lr=0.001, device=torch.device('cuda:0'), checkpoint_dir='')
    
#     state = torch.rand(size=(1,30000)).to(torch.device('cuda:0'))
