...
#     raw_state_info = {'steer'      : {'shape': '(1,)',
#                                       'dtype': 'np.float32'}}
#     raw_state_info = parse_raw_state_info(raw_state_info)
    
#     replay_storage = ReplayBufferStorage(raw_state_info=raw_state_info, replay_dir=replay_dir)
    
#     replay_loader = make_replay_loader(replay_dir=replay_dir, raw_state_info=raw_state_info, max_size=1000, batch_size=10,
#                                     num_workers=1, nstep=3, discount=0.99)
    
    
#     next_raw_state = {'steer':np.zeros(shape=(1,))}
...
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
...
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=done)
#         replay_storage.add(action=action, reward=reward, next_raw_state=next_raw_state, done=np.ones(shape=(1,)))
...
#     raw_state, action, reward, discount, next_raw_state, done = tuple(batch)
