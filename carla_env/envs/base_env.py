...
class CarlaEnv():
    ...
    def reset(self):
        ...
        obs_dict['traffic_light'] = {'state' : 0,
                                     'distance' : -1}
    ...
    def step(self, control):
        ...
        obs_dict['traffic_light'] = {'state' : int(info['reward_debug']['debug_texts']['light_state']),
                                     'distance' : float(info['reward_debug']['debug_texts']['light_distance'])}
        
        obs_dict['desired_speed'] = float(info['reward_debug']['debug_texts']['desired_speed'])

        obs_dict['danger'] = int(info['reward_debug']['debug_texts']['danger'])
