...
from utilities.configs import save_config, convert_numpy_dict_to_list_dict, create_empty_file
from utilities.common import recursive_format, format_number


class LogFile():
    def __init__(self, experiment_path, observation_config, policy_config, train_test_config, train_test_config_name, overwrite, fps, resume_training):
        ...
        self.description = train_test_config[0]['description']
        ...
        self.save_config_files(
            observation_config=observation_config, policy_config=policy_config, train_test_config=train_test_config)
        ...
        self.n_logfile_full = 5 if self.train else 1
    ...
    def save_config_files(self, observation_config, policy_config, train_test_config):
        ...
        policy_config_filename = f'{self.experiment_path}/configs/policy.yaml'
        ...
        if self.train:
            ...
            save_config(policy_config, policy_config_filename)
